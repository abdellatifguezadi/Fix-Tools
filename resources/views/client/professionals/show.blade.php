        ...
        <div class="bg-black text-white py-8">
            <div class="container mx-auto px-4">
                <div class="flex items-center justify-between mb-4">
                    <a href="{{ route('client.professionals.index') }}" class="text-yellow-400 hover:text-yellow-300">
                            ...
                            <div class="border rounded-lg p-4 flex items-center">
                                ...
                                <div class="flex-grow">
                                    ...
                                    <div class="flex justify-between items-center">
                                        <span class="font-bold text-yellow-600">{{ number_format($service->base_price, 2) }} DH</span>

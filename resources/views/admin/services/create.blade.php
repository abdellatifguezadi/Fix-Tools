                    ...
                    <div class="space-y-6">
                        ...
                        <div>
                            ...
                            <div class="mt-1 relative rounded-md shadow-sm">
                                ...
                                <input type="number" step="0.01" min="0" name="base_price" id="base_price" value="{{ old('base_price') }}" required
                        ...
                        <div class="flex items-start">
                            <div class="flex items-center h-5">
                                <input id="is_available" name="is_available" type="checkbox" {{ old('is_available') ? 'checked' : '' }}
                    ...
                    <div class="space-y-6">
                        <div>
                            ...
                            <textarea name="description" id="description" rows="5" required
                                class="mt-1 focus:ring-yellow-500 focus:border-yellow-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md">{{ old('description') }}</textarea>
                            @error('description')
                                <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                            @enderror
                        </div>

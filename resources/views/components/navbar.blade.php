<nav class="bg-black py-4">
    <div class="container mx-auto px-4 flex justify-between items-center">
        ...
        <!-- Mobile menu button -->
        <button id="mobileMenuBtn" class="lg:hidden text-yellow-400 hover:text-yellow-300">
            ...
            @auth
                <div class="flex items-center space-x-8">
                    @if(auth()->user()->role === 'client')
                        ...
                        <a href="{{ route('messages.index') }}" class="text-yellow-400 hover:text-yellow-300 flex items-center whitespace-nowrap">
                ...
                <div class="relative ml-4" x-data="{ open: false }">
                    ...
                    <div x-show="open" @click.away="open = false" class="absolute right-0 mt-2 w-48 bg-black border border-gray-700 rounded-md shadow-lg py-1 z-50" style="display: none;">
    ...
    <!-- Mobile menu -->
    <div id="mobileMenu" class="lg:hidden hidden bg-black border-t border-gray-800 mt-4">
        <div class="container mx-auto px-4 py-2">
            ...
            @else
                <a href="{{ route('home') }}" class="block py-2 text-yellow-400 hover:text-yellow-300">Home</a>
                <div class="flex flex-col space-y-2 mt-2 pt-2 border-t border-gray-800">
                    <a href="{{ route('login') }}" class="block py-2 text-center text-yellow-400 hover:text-yellow-300 border border-yellow-400 rounded-lg">Login</a>
                    <a href="{{ route('register') }}" class="block py-2 text-center text-black bg-yellow-400 hover:bg-yellow-300 rounded-lg">Register</a>
                </div>
            @endauth
        </div>
    </div>
